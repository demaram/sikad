		...
		<div class="main">
			...
			<!-- END NAVBAR -->
               <?php
                    ...
                    $data_kelas = $this->db->query("SELECT * FROM tbl_siswa WHERE id_siswa = '$id_siswa'"); // id_siswa diambil dari session
					...
					<div class="panel panel-headline">
                              <div class="panel">
                                   ...
                                   <div class="panel-body no-padding">
                                        ...
                                        <form class="form-horizontal" action="<?=base_url()?>user/home/<?=$nama_form?>" role="form" method="post" enctype="multipart/form-data" >
...
<script type="text/javascript">
     $(document).ready(function(){
          $("#old_pass").change(function(){
               ...
               $.ajax({
                    type : "POST",
                    url : "<?=base_url();?>user/home/ajax_password",
                    data : {old_pass:old_pass, id_siswa:id_siswa},
