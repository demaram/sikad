                                            ...
                                            <div  style="width:95% ; margin-left:auto; margin-right:auto">
                                                      ...
                                                      <table class="table table-striped table-inverse">
                                                            ...
                                                            <tbody>
                                                                 <?php
                                                                      ...
                                                                      $query  = $this->db->query("SELECT * FROM nilai_harian where id_pd_siswa = '$id_pd_siswa' AND id_matpel= '$id_matpel'");
                                                                      $no = 1;
                                                 ...
                                                 <div class="col-md-6">
                                                      ...
                                                      <table class="table table-striped table-inverse">
                                                            ...
                                                            <tbody>
                                                                 <?php
                                                                      $query  = $this->db->query("SELECT * FROM  nilai_tugas where id_pd_siswa = '$id_pd_siswa' AND id_matpel= '$id_matpel'");
                                                                      $no = 1;
                                            ...
                                            <div  style="width:95% ; margin-left:auto; margin-right:auto">
                                                 <div class="col-md-12">
                                                      ...
                                                      <table class="table table-striped table-inverse">
                                                            ...
                                                            <tbody>
                                                                 <?php
                                                                      $uas  = $this->db->query("SELECT * FROM nilai_uas where id_pd_siswa = '$id_pd_siswa' AND id_matpel= '$id_matpel'");
                                                                      $no = 1;
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
                              <div class="panel">
                                   ...
                                   <div class="panel-body no-padding">
                                        <!--Mulai Form-->
                                          <form class="form-horizontal" action="<?=base_url()?>staff/s_rapor_siswa/proses_tambahl" role="form" method="post" enctype="multipart/form-data" >
                                               <?php
                                                ...
                                                ?>
                                               <input type="hidden" name="id_pd_siswa" value="<?=$id_pd_siswa?>">
