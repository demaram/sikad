                                                  ...
                                                  <div class="panel panel-headline">
                                                       <div class="panel">
                                                            ...
                                                            <div class="panel-body no-padding">
                                                                ...
                                                                ?>
                                                                 <form class="form-horizontal" action="<?=base_url()?>staff/s_nilai_uas/proses_tambah" role="form" method="post" enctype="multipart/form-data">
                                                                      ...
                                                                      <table <?php if($hitung <= 10){echo "class='table table-striped'" ;}else{echo "class='table table-striped data_table'";} ?>>
                                                                           ...
                                                                           <tbody>
                                                                                ...
                                                                                foreach ($data->result() as $row){
                                                                                         ...
                                                                                         $quas= $this->db->query("SELECT * FROM nilai_uas   where id_pd_siswa ='$row->id_pd_siswa' AND id_matpel ='$id_matpel_pilih'");
                                                                                              foreach ($quas->result() as $uas) { }
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input type="text" class="form-control setengah number" name="nilai_uas_angka_<?=$row->id_pd_siswa?>" value="<?=$uas->nilai_uas_angka?>" maxlength="3"></td>
