                                                  ...
                                                  <div class="panel panel-headline">
                                                       <div class="panel">
                                                            ...
                                                            <div class="panel-body no-padding">
                                                                ...
                                                                ?>
                                                                 <form class="form-horizontal" action="<?=base_url()?>staff/s_nilai_harian/proses_tambah" role="form" method="post" enctype="multipart/form-data">
                                                                      ...
                                                                      <table <?php if($hitung <= 10){echo "class='table table-striped'" ;}else{echo "class='table table-striped data_table'";} ?>>
                                                                           ...
                                                                           <tbody>
                                                                                ...
                                                                                foreach ($data->result() as $row){
                                                                                         ...
                                                                                         $qharian = $this->db->query("SELECT * FROM nilai_harian where id_pd_siswa ='$row->id_pd_siswa' AND id_matpel ='$id_matpel_pilih' AND tgl_nilai='$tgl_nilai'");
                                                                                              foreach ($qharian->result() as $harian) { }

                                                                                         $qskala = $this->db->query("SELECT * FROM skala_nilai");
