                                        ...
                                        <table class="table table-striped ">
                                              ...
                                              <tbody>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td><?=$row->kelompok?></td>
                                                        <td><a href="<?=base_url()?>staff/s_nilai_harian/get_siswa?id_matpel=<?=$row->id_matpel?>&id_kelas=<?=$id_kelas?>&smt=<?=$smt->id_smt?>&day=<?=$tgl_nilai?>" class="btn btn-primary">Set Up Nilai</a></td>
                                                   </tr>
                                                   <?php $no++; endforeach; ?>
                                              </tbody>
                                        </table>
