		...
		<div class="main">
			...
			<!-- END NAVBAR -->
               <?php
                    ...
                    $data = $this->db->query("SELECT * FROM `nilai_harian` a JOIN tbl_pd_siswa b
                                       ...
                                       <table class="table table-striped data_table">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td><?=$row->nilai_angka_reseptif?> (<?=$row->nilai_huruf_reseptif?>) </td>
                                                       <td><?=$row->nilai_angka_ekspresif?> (<?=$row->nilai_huruf_ekspresif?>)</td>
                                                       <td><?=$row->tgl_nilai?></td>
