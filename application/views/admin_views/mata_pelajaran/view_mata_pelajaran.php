...
<body>
	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<!-- END NAVBAR -->
               <?php
                    $data = $this->db->query("SELECT * FROM mata_pelajaran where id_matpel NOT IN (0,99)");
                ?>
                              ...
                              <div class="panel">
                                   <div class="panel-heading">
                                       ...
                                       <div class="right">
                                            ...
                                            <a href="<?=base_url()?>admin/mata_pelajaran/tambah_data"><i class="fa fa-plus fa-2x"></i></a>
                                       ...
                                       <table class="table table-striped data_table">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td style="text-align:center"><a href="<?=base_url()?>admin/mata_pelajaran/edit_data?id=<?=$row->id_matpel?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                                                            <a href="<?=base_url()?>admin/mata_pelajaran/proses_hapus?id=<?=$row->id_matpel?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                                       </td>
                                                  </tr>
                                                  <?php $no++; endforeach; ?>
                                             </tbody>
