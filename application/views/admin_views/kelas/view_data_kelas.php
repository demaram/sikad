                              ...
                              <div class="panel">
                                   <div class="panel-heading">
                                       ...
                                       <div class="right">
                                            ...
                                            <a href="<?=base_url()?>admin/kelas/tambah_data"><i class="fa fa-plus fa-2x"></i></a>
                                       ...
                                       <table class="table table-striped data_table">
                                             ...
                                             <tbody>
                                                  ...
                                                  foreach ($data_kelas->result() as $row):
                                                       $guru = $this->db->query("SELECT * FROM users where id_user ='$row->id_guru_wali'");
                                                       foreach ($guru->result() as $guru) {
                                                            // Ambil data guru dari table guru ke table kelas
                                                       }
                                                       ?>
                                                  <tr>
                                                       <td><?=$no?></td>
                                                       ...
                                                       <td><a href="<?=base_url()?>admin/kelas/kelas_matpel?id=<?=$row->id_kelas?>" class="btn btn-primary">Lihat Jadwal</span></a></td>
                                                       <td><?=$row->keterangan?></td>
                                                       <td><?=$guru->nama?></td>
                                                       <td style="text-align:center; display:inline-block"><a href="<?=base_url()?>admin/kelas/edit_data?id=<?=$row->id_kelas?>" class="btn btn-success btn-xs"><span class="fa fa-edit"></span></a>
                                                            <a href="<?=base_url()?>admin/kelas/proses_hapus?id=<?=$row->id_kelas?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span></a>
                                                       </td>
                                                  </tr>
                                                  <?php $no++; endforeach; ?>
                                             </tbody>
