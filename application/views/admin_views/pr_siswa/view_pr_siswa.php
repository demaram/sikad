...
<body>
	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<!-- END NAVBAR -->
               <?php
                    $data = $this->db->query("SELECT * FROM tbl_pr");
                ?>
                              ...
                              <div class="panel">
                                   <div class="panel-heading">
                                       ...
                                       <div class="right">
                                            ...
                                            <a href="<?=base_url()?>admin/pr_siswa/tambah_data"><i class="fa fa-plus fa-2x"></i></a>
                                       ...
                                       <table class="table table-striped data_table">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td><?=$row->detail?></td>
                                                       <td style="text-align:center;display:inline-block"><a href="<?=base_url()?>admin/pr_siswa/edit_data?id=<?=$row->id_pr?>" class="btn btn-success btn-xs"><span class="fa fa-edit"></span></a>
                                                            <a href="<?=base_url()?>admin/pr_siswa/proses_hapus?id=<?=$row->id_pr?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span></a>
                                                       </td>
                                                  </tr>
                                                  <?php $no++; endforeach; ?>
                                             </tbody>
