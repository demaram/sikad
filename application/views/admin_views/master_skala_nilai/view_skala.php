...
<body>
	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<!-- END NAVBAR -->
               <?php
                    $data = $this->db->query("SELECT * FROM skala_nilai where 1=1");
                ?>
					...
					<div class="panel panel-headline">
                              <div class="panel">
                                   <div class="panel-heading">
                                       ...
                                       <div class="right">
                                            <?php
                                                  $nama_controller = 'master_skala_nilai';
                                       ...
                                       <table class="table table-striped data_table">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td><?=$row->nilai_minimum?></td>
                                                       <td><?=$row->nilai_maksimum?></td>
                                                       <td style="text-align:center"><a href="<?=base_url()?>admin/<?=$nama_controller?>/edit_data?id=<?=$row->id_skala_nilai?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                                                            <a href="<?=base_url()?>admin/<?=$nama_controller?>/proses_hapus?id=<?=$row->id_skala_nilai?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                                       </td>
                                                  </tr>
                                                  <?php $no++; endforeach; ?>
                                             </tbody>
